...
db.filmes.find({$or:[{generos:{$in:["Horror"]}},{generos:{$in:["Comedy"]}}],duracao:{$lt:120}}, {_id:0,titulo:1,generos:1,duracao:1})
...
// 07 - Quaal o filme com mais de 3 horas que teve a maior arrecadação.
...
db.filmes.distinct("atores", {generos:{ $in:["Comedy"], $in:["Action"]}, data_estreia:{$gte:new Date(2005,1,1), $lte:new Date(2005,12,31) }} )
